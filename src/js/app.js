...
function bandRow(band) {
    ...
    row.innerHTML =
        ...
        CHEV +
        "</span>" +
        '<span class="f95"><input class="inp" data-f="fc" type="number" step="1" min="20" max="20000" aria-label="Frequency in hertz"><i class="u">Hz</i>' +
        ARROWS +
        "</span>" +
        '<div class="r2">' +
        '<span class="f95"><input class="inp" data-f="gain" type="number" step="0.5" aria-label="Gain in decibels"><i class="u">dB</i>' +
        ARROWS +
        "</span>" +
        '<span class="f95"><i class="u">Q</i><input class="inp" data-f="q" type="number" step="0.1" aria-label="Q">' +
        ARROWS +
        "</span>" +
...
el.bandList.addEventListener("input", (e) => {
    ...
    patchTimers.set(
        key,
        setTimeout(() => patchField(id, f, raw), 120),
    );
});
