...
import { freqToX, xToFreq, magnitudeDb, bandFromMarks, autoPreamp, fmtHz, fmtK } from "../src/js/dsp.js";
...
const MAG_CASES = [
    ...
    [
        "LSC 105 +2.0 q0.7",
        { type: "LSC", fc: 105, gain: 2.0, q: 0.7 },
        [
    ...
    [
        "HSC 8000 -3.0 q0.7",
        { type: "HSC", fc: 8000, gain: -3.0, q: 0.7 },
        [
